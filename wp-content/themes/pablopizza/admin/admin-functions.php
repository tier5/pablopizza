...
function optionsframework_admin_head() { 
    ...
    jQuery(function(){
	var message = '<p>Thanks for installing "Launched Yet?" Theme, designed and developed by henerz-designs.com, this theme comes with an <a href="<?php echo admin_url('admin.php?page=optionsframework'); ?>">options panel</a> to configure settings.</p>';
