...
<div class="wrap" id="of_container">
  ...
  <form action="" enctype="multipart/form-data" id="ofform">
    <div id="header">
      <div class="logo">
        <!--<img src="<?php //bloginfo("template_url"); ?>/admin/images/admin_header.png" />-->
      </div>
    ...
    <img style="display:none" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/admin/images/loading-bottom.gif" class="ajax-loading-img ajax-loading-img-bottom" alt="Working..." />
...
function optionsframework_machine($options) {
	...
	foreach ($options as $value) {
		...
		case "heading":
			...
			$jquery_click_hook = preg_replace('/\s+/', '', $jquery_click_hook);
